...
front face. Doors and windows are punched *out* of walls by the generator, so
their sprites rebuild the missing wall segment (`isWallGap` on the tile keeps
the run connected) and inset wood or glass into it.
